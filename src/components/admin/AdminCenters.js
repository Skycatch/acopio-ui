				...
				return (
					<TableRow key={center.id} className="rowhover">
						<TableRowColumn style={styles.smallCol}>
							<Link to={'/control/'+center.id}>{index+1}</Link>
						</TableRowColumn>
						<TableRowColumn>
							<Link to={'/control/'+center.id}>{center.id}</Link>
						</TableRowColumn>
						<TableRowColumn>
							<Link to={'/control/'+center.id}>{center.nombre}</Link>
						</TableRowColumn>
			...
			<div className="content container">
				<div className="AdminCenters">
					...
					<div className="row cf">
						...
						<RaisedButton label="+ Agregar nuevo" primary={true} className="u-fr" />
					</div>
